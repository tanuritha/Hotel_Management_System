...
public class SignUp extends JFrame {
	...
	public SignUp() throws SQLException {
		...
		JLabel lblSearchForRoom = new JLabel("Signup by entering your details.");
		...
		JButton btnSearch = new JButton("Signup");
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                String str = "INSERT INTO user values( '"+s1+"', '"+s2+"', '"+s3+"','"+s4+"', '"+s5+"', '"+s6+"', '"+s7+"', '"+s8+"')";
              
                
		c.s.executeUpdate(str);
                JFrame frame = new JFrame("Signup Successsful!");
                JOptionPane.showMessageDialog(frame, "Thank you for Signing up","Signup Successful!", JOptionPane.PLAIN_MESSAGE);
